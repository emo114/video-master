<template>
  <div class="video">
    ...
    <div class="advertisement">
      <img src="http://114.29.253.178:8888/group1/M00/00/2C/Z2Q-xl1Bi_6AJS9lAAGbVxDl2-Y994.gif" alt="">
    </div>
    <div class="like">
      <span>猜你喜欢</span>
    </div>
    ...
    <br>
    <span @click="showMoreMovie" v-show="!isShowMoreMovie&&videoDetails.likeVideoList.length>0" style="justify-content:center; display: flex;color:  #AA845D;font-family:'楷体';">查看更多&#8595;</span>
    ...
    <hr>
    <div class="commentContainer"  v-for="i in 2" v-show="videoDetails.videoCommentNum">
      <div  class="user">
        <img class="headPortrait" src="../../img/Icon/1.jpg" alt="">
        <span class="gender"></span>
        <!--              <img class="gender" src="../../img/Icon/1.jpg" alt="">-->
        <span>{{videoDetails.pushTime}}</span>
      </div>
      <div class="comment1">
        <span>没用</span>
...
<script>
  ...
  import { Toast,XHeader,Scroller,Tabbar, TabbarItem,Flexbox,FlexboxItem,XProgress,Popup,XDialog, XButton, TransferDomDirective as TransferDom  } from 'vux'
  ...
  export default {
    ...
    data() {
      return {
        ...
        videoDetails:{
          ...
          videoCoverType: 1,
          likeVideoList:[],
          videoCover: "http://114.29.253.178:8888/group1/M00/00/52/ch39sl1--MiAZoVgAAAllbhnGa4397.jpg",
          isCare: "0",
          loseNum: 0,
          cup: "大陆"
        }
    ...
    methods: {
      ...
      },async sendPraise(params){   //异步发送点赞请求
