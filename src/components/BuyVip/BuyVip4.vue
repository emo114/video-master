      ...
      <div  class="pay">
        ...
        <table>
          <tr>
            ...
            <td @click="selectPayTypeFn(3)"><span class="iconfont">&#xe638;</span><span>卡密激活</span></td>
            <!--<td><span class="iconfont">&#xe60c;</span><span>支付宝</span></td>
            <td><span class="iconfont">&#xe619;</span><span>微信</span> </td>
            <td ><span class="iconfont">&#xe638;</span><span>卡密激活</span></td>-->
          </tr>
        </table>
      </div>
      <!-- <div class="cardcode">
         <input type="text"  id="code" placeholder="请输入卡密"  />
         <input type="button"  id="use"   value="使用"/>
       </div>-->
